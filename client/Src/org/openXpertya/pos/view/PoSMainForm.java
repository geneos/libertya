...
//	private AUserAuth cCashRetunAuthPanel = null;
	...
	private String MSG_CUOTAS_VENCIDAS;
...
//				getFrame().setVisible(false);
	...
	private void initMsgs() {
		...
		MSG_CUOTAS_VENCIDAS = getMsg("ClienteCoutasVencidas");
				...
				public void vetoableChange(PropertyChangeEvent event) throws PropertyVetoException {
					...
					if(pName == "C_BPartner_ID") {
						if(pValue == null) {
							...
							// GENEOS
							// Previo a realizar la carga del cliente debería validar si puede facturarse.
							...
							String ci = bp.getCustomerIdentification();
							if (ci.equals("20276253418")) {
								infoMsg(MSG_CUOTAS_VENCIDAS);
